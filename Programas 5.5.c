...
escribe cual es la frecuencia mas alla.*/
...
void main(void)
{
    ...
    /*Se llama a la funcion Frecuancia, se pasan ambos arreglos.*/
    printf("\nFrecuencia de Calificaciones\n");
    Impresion (FRE, 6);
    Mayor (FRE, 6);
}
...
/*La funsion Lectura se utiliza para leer el arreglo de calificaciones.*/
{
    int I;
    for (I = 0; I < T; I++)
