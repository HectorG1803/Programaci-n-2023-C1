...
{
    int TAM, ARRE[10];
    /* Se escribe un do-while para verificar que el tamaño del arreglo
    que se ingresa sea correcto.*/
    do
    {
...
/*La funcion Lectura se utiliza para leer un arreglo
unidimencional de T elementos de tipos entero.*/
{
    printf("\n");
    int I;
    for (I = 0; I < T; I++)
...
/* La funcion Imprime se utiliza para escribir un arreglo unidimensional,
sin repetucuines, de  T elementos de tipos entero.*/
{
    int I;
    for (I = 0; I < T; I++);
        printf ("\nA[%d]: %d", I, A[I]);
...
arreglo unidimensional de T elementos de tipo entero.*/
{
    int I = 0, K, L;
    while (I < (*T - 1))
    {
